...
export const UPDATEDIALOGBYID = 'UPDATE_DIALOG_BY_ID';
export const CHECKEXISTSDIALOGS = 'CHECK_EXISTS_DIALOGS';
export const MARKMESSAGESASREADLOCALLY = 'MARK_MESSAGES_AS_READ_LOCALLY';
export const CLAERDIALOGS = 'CLAER_DIALOGS';
